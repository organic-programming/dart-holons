...
const DescribeResponse$json = {
  ...
  '2': [
    ...
    {'1': 'motto', '3': 2, '4': 1, '5': 9, '10': 'motto'},
    {
      '1': 'services',
      '3': 3,
      '4': 3,
      '5': 11,
      '6': '.holonmeta.v1.ServiceDoc',
      '10': 'services'
    },
  ],
};
...
final $typed_data.Uint8List describeResponseDescriptor = $convert.base64Decode(
    'ChBEZXNjcmliZVJlc3BvbnNlEhIKBHNsdWcYASABKAlSBHNsdWcSFAoFbW90dG8YAiABKAlSBW'
    '1vdHRvEjQKCHNlcnZpY2VzGAMgAygLMhguaG9sb25tZXRhLnYxLlNlcnZpY2VEb2NSCHNlcnZp'
    'Y2Vz');
...
final $typed_data.Uint8List serviceDocDescriptor = $convert.base64Decode(
    ...
    'Rlc2NyaXB0aW9uEjEKB21ldGhvZHMYAyADKAsyFy5ob2xvbm1ldGEudjEuTWV0aG9kRG9jUgdt'
    'ZXRob2Rz');
...
final $typed_data.Uint8List methodDocDescriptor = $convert.base64Decode(
    ...
    'GAQgASgJUgpvdXRwdXRUeXBlEjkKDGlucHV0X2ZpZWxkcxgFIAMoCzIWLmhvbG9ubWV0YS52MS'
    '5GaWVsZERvY1ILaW5wdXRGaWVsZHMSOwoNb3V0cHV0X2ZpZWxkcxgGIAMoCzIWLmhvbG9ubWV0'
    'YS52MS5GaWVsZERvY1IMb3V0cHV0RmllbGRzEikKEGNsaWVudF9zdHJlYW1pbmcYByABKAhSD2'
    'NsaWVudFN0cmVhbWluZxIpChBzZXJ2ZXJfc3RyZWFtaW5nGAggASgIUg9zZXJ2ZXJTdHJlYW1p'
    'bmcSIwoNZXhhbXBsZV9pbnB1dBgJIAEoCVIMZXhhbXBsZUlucHV0');
...
final $typed_data.Uint8List fieldDocDescriptor = $convert.base64Decode(
    ...
    'VtYmVyGAMgASgFUgZudW1iZXISIAoLZGVzY3JpcHRpb24YBCABKAlSC2Rlc2NyaXB0aW9uEi4K'
    'BWxhYmVsGAUgASgOMhguaG9sb25tZXRhLnYxLkZpZWxkTGFiZWxSBWxhYmVsEiAKDG1hcF9rZX'
    'lfdHlwZRgGIAEoCVIKbWFwS2V5VHlwZRIkCg5tYXBfdmFsdWVfdHlwZRgHIAEoCVIMbWFwVmFs'
    'dWVUeXBlEjsKDW5lc3RlZF9maWVsZHMYCCADKAsyFi5ob2xvbm1ldGEudjEuRmllbGREb2NSDG'
    '5lc3RlZEZpZWxkcxI7CgtlbnVtX3ZhbHVlcxgJIAMoCzIaLmhvbG9ubWV0YS52MS5FbnVtVmFs'
    'dWVEb2NSCmVudW1WYWx1ZXMSGgoIcmVxdWlyZWQYCiABKAhSCHJlcXVpcmVkEhgKB2V4YW1wbG'
    'UYCyABKAlSB2V4YW1wbGU=');
